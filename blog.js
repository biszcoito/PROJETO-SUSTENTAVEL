document.addEventListener("DOMContentLoaded", () => {
  ...
  window.addEventListener("blogContentUpdated", () => {
    console.log("Conteúdo atualizado na página do blog, recarregando...")
    loadBlogContent()
  })
  ...
  window.addEventListener("storage", (e) => {
    if (e.key === "ascamarea_blog_content") {
      console.log("Dados atualizados em outra aba, recarregando blog...")
      loadBlogContent()
    }
  })
...
function loadBlogContent() {
  ...
  if (typeof window.blogData === "undefined") {
    ...
    blogPostsContainer.innerHTML = '<div class="empty-message">Erro ao carregar dados do blog.</div>'
    return
  }
  ...
  if (announcements && announcements.length > 0) {
    ...
    announcementsContainer.innerHTML = '<div class="empty-message">Nenhum comunicado disponível no momento.</div>'
  }
  ...
  console.log("Blog carregado:", articles.length, "artigos,", announcements.length, "comunicados")
}
